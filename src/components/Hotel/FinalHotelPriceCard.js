...
function FinalHotelPriceCard() {
  ...
  return (
    <>
      <aside>
        <div className="aside">
          <div className="mainhotel-rightside-div">
            <div className="hotel-billing-data">
              {/* <div>
              ...
              <div className="bill-price">
                <h2 style={{ fontSize: "", lineHeight: "20px" }}>
                  Price breakup
                </h2>
                {/* <div
                  style={{
            ...
            <div className="other-expense">
              <div style={{ padding: "0px 16px 16px 16px" }}>
                <div className="otherexpense-data">
                  <p className="roomexpense-details">1 room x 1 night</p>
                  <p className="roomexpense-details">₹ {RoomPrice}</p>
                </div>
                <div className="otherexpense-data">
                  <p className="roomexpense-details">Hotel taxes</p>
                  <p className="roomexpense-details">
                    ₹ {(RoomPrice * 4) / 100}
                  </p>
                </div>
                <div className="otherexpense-data">
                  <p className="roomexpense-details">Property discount</p>
                  <p className="roomexpense-details">
                    -₹{(RoomPrice * 3) / 100}
                  </p>
                </div>
                <div className="pricecard-line"></div>
                <div className="otherexpense-data">
                  <h4 className="roomexpense-total">Total</h4>
                  <h2 className="roomexpense-totalPrice">
                    ₹{" "}
          ...
          <div className="hotelmain-offer-div">
...
export default FinalHotelPriceCard;
